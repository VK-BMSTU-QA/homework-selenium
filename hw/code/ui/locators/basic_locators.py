...
class BasePageLocators:
    ...
    BUTTON_SUBSCRIPTION = (By.XPATH, '//*[@id="header"]/div[1]/div[5]/div/div[2]/a[2]')
...
class ProfilePageLocators(BasePageLocators):
    LOGIN_INPUT = (By.XPATH, '//*[@id="root"]/div[3]/div/form/div[1]/div[2]/div[1]/div[1]/input')
    PASSWORD_INPUT = (By.XPATH, '//*[@id="root"]/div[3]/div/form/div[1]/div[2]/div[3]/div[1]/input')
    PASSWORD_COPY_INPUT = (By.XPATH, '//*[@id="root"]/div[3]/div/form/div[1]/div[2]/div[4]/div[1]/input')
    
    PASSWORD_NOTIFICATION = (By.XPATH, '//*[@id="root"]/div[3]/div/form/div[1]/div[2]/div[3]/div[2]')
    PASSWORD_COPY_NOTIFICATION = (By.XPATH, '//*[@id="root"]/div[3]/div/form/div[1]/div[2]/div[4]/div[2]')
